...
public class editinfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer Name", "Mobile number", "Pincode", "address", "Password"
            }
        ));
        jScrollPane1.setViewportView(jTable1);
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            jTable1.getColumnModel().getColumn(0).setHeaderValue("Customer Name");
            jTable1.getColumnModel().getColumn(1).setHeaderValue("Mobile number");
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Pincode");
